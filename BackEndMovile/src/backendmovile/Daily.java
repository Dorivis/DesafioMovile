...
public class Daily 
{
    ...
    private int active_base_total;
    private int new_subscriber_total;
    private int cancelation_total;
    private char cancellation_type;  

    public Daily(String inserted_date, int carrier_id, String carrier_name, int application_id, String application_name, double price_value, double carrier_gross_revenue_value, boolean active_base_total, boolean new_subscriber_total, boolean cancelation_total, char cancellation_type) {
    ...
    public Daily(String[] vetor){
        this.inserted_date = vetor[0];
        this.carrier_id = Integer.parseInt(vetor[1]);
        this.carrier_name = vetor[2];
        this.application_id = Integer.parseInt(vetor[3]);
        this.application_name = vetor[4];
        this.price_value = Double.parseDouble(vetor[5]);
        this.carrier_gross_revenue_value = Double.parseDouble(vetor[6]);
        this.active_base_total = Integer.parseInt(vetor[7]);
        this.new_subscriber_total = Integer.parseInt(vetor[8]);
        this.cancelation_total = Integer.parseInt(vetor[9]);
        this.cancellation_type = vetor[10].charAt(0);
    }
