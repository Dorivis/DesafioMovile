...
public class IGPM 
{
    ...
    public IGPM(String[] vetor){
        this.carrier_id = Integer.parseInt(vetor[0]);
        this.application_id = Integer.parseInt(vetor[1]);
        this.price_value = Double.parseDouble(vetor[2]);
        this.carrier_tax = Double.parseDouble(vetor[3]);
        this.share_movile = Double.parseDouble(vetor[4]);
    }
